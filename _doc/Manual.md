...
```yml
# Site settings
title: hongxuke Blog             # title of your website
SEOTitle: hongxuke Blog          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: hongxukepro     # modify this account to yours
weibo_username: hongxukepro      # the footer woule be auto-updated.
...
sidebar-avatar: /img/avatar-hongxuke.jpg     # use absolute URL.
```
...
It's possible that you want the two things different. For me, my site-title is **“hongxuke Blog”** but I want the title shows in search engine is **“柯洪旭的博客 | hongxuke Blog”** which is multi-language.
...
- Fixed [issue#15](https://github.com/hongxukepro/hongxukepro.github.io/issues/15) about code wrap.
