...
const PRECACHE_LIST = [
  ...
  "./js/jquery.min.js",
  "./js/bootstrap.min.js",
  "./js/hongxuke-blog.min.js",
  "./js/snackbar.js",
  "./img/icon_wechat.png",
  "./img/avatar-hongxuke.jpg",
  "./img/home-bg.jpg",
  "./img/404-bg.jpg",
  "./css/hongxuke-blog.min.css",
...
// Tracking https://twitter.com/hongxukepro/status/798816417097224193
...
function sendMessageToClientsAsync(msg) {
  ...
  // https://twitter.com/hongxukepro/status/799265578443751424
